function getUrlParams(t) {
  ...
  for (a = 0; a < n.length; a++) if ((e = n[a].split("="))[0] === t) return void 0 === e[1] || decodeURIComponent(e[1]);
}
var Mophy = (function () {
  var t = $(window).width(),
    e = function () {
      (jQuery(".default-select").length > 0 && jQuery(".default-select").selectpicker(), $("select:not(.select2):not(.single-select):not(.native-select)").selectpicker());
    },
    a = function () {
      ...
      if ($(".draggable-zone").length > 0) {
        var t = {
          init: function () {
            ...
            new Sortable.default(t, { draggable: ".draggable", handle: ".draggable.draggable-handle", mirror: { appendTo: "body", constrainDimensions: !0 } }).on("drag:stop", () => {
              setTimeout(function () {
                var t;
                ((t = 0),
    ...
    k = function () {
      (jQuery("#lightgallery").length > 0 && $("#lightgallery").lightGallery({ loop: !0, thumbnail: !0, exThumbImage: "data-exthumbimage" }), jQuery("#lightgallery2").length > 0 && $("#lightgallery2").lightGallery({ loop: !0, thumbnail: !0, exThumbImage: "data-exthumbimage" }));
    },
    C = function () {
  ...
  return {
    init: function () {
      (a(), n(), o(), i(), c(), l(), d(), r(), h(), u(), p(), f(), g(), m(), b(), v(), y(), k(), s(), e(), C(), x(), z(), w());
    },
    load: function () {
      (e(), a());
    },
