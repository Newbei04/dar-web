		...
		<div class="row">
			<div class="col-lg-6 align-self-start">
				<div class="account-info-area" style="background-image: url(<?= $baseURL ?>assets/images/rainbow.gif)">
					<div class="login-content">
						<p class="sub-title">Account Locked in to your admin dashboard with your credentials</p>
			...
			<div class="col-lg-6 col-md-7 col-sm-12 mx-auto align-self-center">
				<div class="login-form">
					...
					<h6 class="login-title"><span>Account Locked</span></h6>
					<div class="row mb-5">
						...
						<div class="col-xl-6 col-sm-6">
							<a href="javascript:void(0);" class="btn btn-outline-black d-block social-btn apple">
					...
					<form action="<?= $baseURL ?>home">
						...
						<div class="form-row d-flex justify-content-between mt-4 mb-2">
							...
							<div class="">
								<a href="<?= $baseURL ?>page-forgot-password" class="btn-link text-primary">Need Help?</a>
							</div>
						</div>
