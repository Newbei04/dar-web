...
<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Add Beneficiary</a></li>
        </ol>
    </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">Add Beneficiary</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="doc_num" placeholder="e.g. 00-000000-0" maxlength="11" required>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function resetSelect(el, placeholder) {
            el.prop("disabled", true).html(`<option value="">${placeholder}</option>`).selectpicker('refresh');
        }
                ...
                success: function(res) {
                    ...
                    if (res.code == 0) {
                        Swal.fire("Success", res.message, "success")
                            .then(() => window.location.href = "<?= $baseURL ?>beneficiary-list");
                    } else {
