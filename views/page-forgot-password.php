			...
			<div class="col-lg-6 align-self-start">
				<div class="account-info-area" style="background-image: url(<?= $baseURL ?>assets/images/rainbow.gif)">
					<div class="login-content">
						<p class="sub-title">Forgot Password in to your admin dashboard with your credentials</p>
			...
			<div class="col-lg-6 col-md-7 col-sm-12 mx-auto align-self-center">
				<div class="login-form">
					<div class="login-head">
						...
						<p>Forgot Password allows users to enter login credentials for authentication and access to secure content.</p>
					</div>
